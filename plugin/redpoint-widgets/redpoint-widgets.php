...
define( 'REDPOINT_WIDGETS_VERSION', '1.11.2' );
...
add_action(
	...
	function ( $widgets_manager ) {
		...
		require_once REDPOINT_WIDGETS_PATH . 'widgets/class-newsletter-widget.php';
		...
		$widgets_manager->register( new \RedPoint\Widgets\Newsletter_Widget() );
...
add_action(
	...
	function () {
		...
		wp_register_script(
			'redpoint-newsletter',
			REDPOINT_WIDGETS_URL . 'assets/js/redpoint-newsletter.js',
			array(),
			REDPOINT_WIDGETS_VERSION,
			true
		);
...
function redpoint_widgets_enqueue_assets() {
	...
	wp_enqueue_style(
		'redpoint-widgets-newsletter',
		REDPOINT_WIDGETS_URL . 'assets/css/redpoint-newsletter.css',
		array( 'redpoint-widgets' ),
		REDPOINT_WIDGETS_VERSION
	);
